package pt.utl.ist.bw.worklistmanager;
...
/**
 * Keeps the log and the system state:
 * - activities/goals executed
 * - activities/goals skipped
 * - activities/goals not executed
 * - goals created
 * - pre-activities created
